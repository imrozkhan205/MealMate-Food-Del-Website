...
import axios from "axios"; // Add this line to avoid error - 
import { useNavigate } from "react-router-dom";

const PlaceOrder = () => {
  const {
     getDiscountedTotal, token, food_list, cartItems,url,getTotalCartAmount } = useContext(StoreContext);
